...
export const ptArticles: ArticleSet = {
  "block-distracting-websites-mac": {
    ...
    title: "Como Bloquear Websites Distrativos no Mac",
    description: "Abre o navegador para verificar uma coisa e 40 minutos depois está profundamente envolvido numa thread do Reddit. o macOS não vem com um verdadeiro bloqueador de websites — aqui está como corrigir isso.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
<p>Senta-se para trabalhar, abre Safari ou Chrome, e antes mesmo de chegar ao separador de que precisava já digitou "r-e-d" na barra de endereços por memória muscular. Quarenta minutos depois sai de uma thread sobre se hot dogs são sanduíches. O trabalho ainda está à espera.</p>

<p>Isto não é um problema de força de vontade. É um problema de conceção. Os navegadores são construídos para o levar ao conteúdo tão rápido quanto possível — incluindo o conteúdo que está a tentar evitar.</p>

<h2>Por Que o macOS Não Resolve Isto</h2>
<p>A Apple adicionou limites de websites do Screen Time no macOS Catalina, mas funcionam apenas no Safari. Se também usa Chrome, Firefox, Arc ou qualquer outro navegador, esses limites não fazem nada. Pode também dispensar os prompts do Screen Time com um clique — é uma redução de velocidade, não uma parede.</p>
...
<h2>Bloqueie Websites em Todo o Sistema com Lock In!</h2>
...
<h3>Listas de Bloqueio Predefinidas</h3>
<p>Lock In! vem com listas de bloqueio curadas para Redes Sociais, Entretenimento, Notícias e Compras. Um clique bloqueia dezenas de domínios que roubam tempo. Também pode adicionar URLs personalizadas para qualquer coisa específica dos seus hábitos de navegação.</p>

<h3>Sessões Temporizadas</h3>
<p>Defina uma sessão de concentração para 25 minutos, uma hora ou qualquer duração personalizada. Os sites bloqueados permanecem bloqueados até o temporizador acabar. Nenhuma extensão de navegador para desativar, nenhum ficheiro hosts para reverter — funciona ao nível do sistema.</p>

<h3>Modo Rigoroso</h3>
<p>Se é do tipo que cancela um bloqueio dois minutos depois de começar, ative o Modo Rigoroso. Depois de uma sessão começar, não há forma de terminá-la mais cedo. Os sites permanecem bloqueados. Pronto.</p>

<p>Blocking distracting websites shouldn't require a computer science degree. It should take two clicks from your menu bar. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "website-blocker-focus-mac": {
    slug: "website-blocker-focus-mac",
    title: "Melhor Bloqueador de Websites para Concentração no Mac",
    description: "As extensões de navegador são fáceis de desativar, Screen Time cobre apenas o Safari, e as modificações de ficheiros hosts precisam de Terminal. Um bloqueador ao nível do sistema que funcione em todos os navegadores é a peça que falta.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
<p>Existem dezenas de bloqueadores de websites para Mac. A maioria deles são extensões de navegador — e esse é o problema. As extensões podem ser desativadas em três segundos. Quando o seu cérebro está a ansiar por uma distração, três segundos é nada.</p>

<p>Um bloqueador de websites orientado para a concentração precisa funcionar abaixo do nível do navegador. Precisa bloquear sites independentemente de qual navegador abra, e precisa tornar o desbloqueio inconveniente o suficiente para que não se preocupe.</p>

<h2>Por Que a Maioria dos Bloqueadores Fica Aquém</h2>
<p>As extensões de navegador controlam apenas um navegador. Se bloquear Twitter no Chrome, pode abrir Safari e fazer scroll livremente. Os limites de websites do Screen Time aplicam-se apenas ao Safari e podem ser dispensados com um clique. As edições de ficheiros hosts requerem acesso ao Terminal e deixam resíduo se esquecer de limpá-los.</p>

<p>Um bloqueador que depende da sua cooperação não está realmente a bloquear nada. Está a sugerir. E as sugestões não funcionam quando a dopamina está envolvida.</p>

<h2>Lock In! — Bloqueio ao Nível do Sistema a Partir da Barra de Menu</h2>
...
<h3>Sessões de Concentração com Um Clique</h3>
<p>Lock In! vive na sua barra de menu. Clique, escolha uma duração e inicie uma sessão. A sua lista de bloqueio ativa-se instantaneamente. Sem separadores de navegador para fechar, sem páginas de configurações para navegar — apenas clique e concentre-se.</p>

<h3>Bloqueio de Aplicações Também</h3>
<p>Os websites não são o único problema. Lock In! também pode bloquear aplicações distratativas. Quando tenta abrir uma aplicação bloqueada durante uma sessão, um painel de ecrã inteiro o interceta e o envia de volta para trabalhar. Cobre ambos os vetores de ataque — navegador e aplicação.</p>

<h3>Estatísticas Diárias</h3>
<p>Um gráfico de barras de 7 dias mostra o seu histórico de concentração. Ver uma sequência de sessões de trabalho profundo é motivador. Ver uma lacuna o torna querer preenchê-la. Os dados o mantêm honesto sem ser moralista a respeito.</p>

<h3>Teclas de Atalho Globais</h3>
<p>Inicie ou verifique uma sessão sem tocar no rato. Atribua um atalho de teclado global e dispare o modo de concentração de qualquer lugar do seu Mac.</p>

<p>The best website blocker is the one you can't cheat. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "block-tiktok-mac": {
    slug: "block-tiktok-mac",
    title: "Como Bloquear TikTok no Mac Durante o Trabalho",
    description: "O algoritmo do TikTok foi concebido para o manter a fazer scroll indefinidamente. Quando está a apenas um separador de distância do seu trabalho, só a força de vontade não é suficiente.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
<p>TikTok é a armadilha de atenção mais eficaz já construída. O seu algoritmo aprende o que o mantém a ver e serve um fluxo infinito disso. Abrir TikTok "por apenas um segundo" durante o trabalho é como comer uma batata de um saco concebido para o fazer terminar.</p>

<p>No seu telefone, pode eliminar a aplicação ou usar Screen Time do iOS. Mas no seu Mac, tiktok.com está sempre a um separador de distância. E o macOS não o oferece uma forma simples de bloqueá-lo.</p>

<h2>Por Que TikTok no Mac É Especialmente Perigoso</h2>
<p>No seu telefone, TikTok parece pelo menos uma atividade separada — levanta fisicamente um dispositivo diferente. No seu Mac, é o mesmo navegador em que trabalha. Está a escrever um relatório num separador, e TikTok está a Cmd+T de distância. Não há mudança de contexto, nenhum atrito, nada para fazer o seu cérebro registar que deixou o modo de trabalho.</p>

<p>A versão web do TikTok agora é completa. A página Para Si funciona de forma idêntica. O algoritmo é igualmente pegajoso. E ao contrário do seu telefone, o seu Mac tem um ecrã maior e um teclado — pode cair ainda mais fundo em secções de comentários e pesquisas.</p>

<h2>Bloqueie TikTok em Todo o Sistema com Lock In!</h2>
...
<p>Lock In! inclui uma lista de bloqueio predefinida de Redes Sociais que cobre TikTok, Instagram, Twitter, Facebook e mais. Ative a predefinição ou adicione tiktok.com como uma entrada personalizada — de qualquer forma, um clique bloqueia-o pela duração da sua sessão.</p>

<h3>Modo Rigoroso para Zero Exceções</h3>
<p>Saber que pode cancelar um bloqueio e abrir TikTok mina todo o ponto. Ative o Modo Rigoroso e o bloqueio torna-se permanente até o temporizador acabar. Não há sobreposição, nenhum botão de emergência, nenhum "apenas cinco minutos." Defina o comprimento da sessão e TikTok permanece bloqueado durante tudo.</p>

<h3>Emparelhe-o com Bloqueio de Aplicações</h3>
<p>Se tem uma aplicação desktop do TikTok ou usa um wrapper como Unite, Lock In! também pode bloqueá-los. A sua funcionalidade de bloqueio de aplicações mostra um painel de interrupção de ecrã inteiro quando tenta lançar uma aplicação bloqueada, então cada caminho para TikTok está fechado.</p>

<p>The algorithm doesn't sleep, so your blocker shouldn't have loopholes. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "cold-turkey-alternative-mac": {
    slug: "cold-turkey-alternative-mac",
    title: "Alternativa a Cold Turkey para Mac",
    description: "Cold Turkey é poderoso mas baseado em Windows, e a versão Mac ficou muito atrás. Uma alternativa nativa para macOS que usa extensões de sistema pode preencher essa lacuna.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
...
<p>A versão Mac do Cold Turkey usa um mecanismo de bloqueio diferente do seu homólogo Windows. macOS é um sistema operacional mais bloqueado, e ferramentas que dependem de workarounds em vez de APIs oficiais da Apple podem quebrar com atualizações do sistema. A aplicação também carece da integração visual que os utilizadores Mac esperam — não parece uma aplicação macOS nativa porque não é.</p>

<p>Além disso, a interface do Cold Turkey carrega complexidade das suas raízes Windows. Funcionalidades como bloqueios agendados, listas de permissão e temporizadores de pausa são poderosas mas podem parecer excessivas se tudo o que quer é bloquear Twitter por duas horas e fazer algum trabalho.</p>
...
<h3>Modo Rigoroso Rivaliza com o Bloqueio do Cold Turkey</h3>
<p>A funcionalidade assinatura do Cold Turkey é o seu modo rigoroso que o impede de desbloquear. Lock In! oferece o mesmo dispositivo de compromisso — ative o Modo Rigoroso e a sua sessão não pode ser cancelada mais cedo. Sem truque de desinstalação, sem atalho de saída. Escolheu a sua duração e vive com isso.</p>

<h3>Bloqueio de Websites e Aplicações Combinados</h3>
<p>Cold Turkey separa o bloqueio de websites e aplicações em produtos diferentes (Cold Turkey Blocker e Cold Turkey Writer). Lock In! lida com ambos numa aplicação. As aplicações bloqueadas disparam um painel de interrupção de ecrã inteiro, e os websites bloqueados falham ao carregar em qualquer navegador.</p>

<h3>Simplicidade da Barra de Menu</h3>
<p>Lock In! vive na sua barra de menu. Não há janela principal para gerir, sem UI de agendamento complexo. Clique no ícone, escolha uma duração, inicie uma sessão. As listas de bloqueio predefinidas para Redes Sociais, Entretenimento, Notícias e Compras significam que pode passar de zero a concentrado em dois cliques.</p>

<p>Same unbreakable blocking, native Mac experience. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "block-apps-during-focus-mac": {
    slug: "block-apps-during-focus-mac",
    title: "Como Bloquear Aplicações Durante Sessões de Concentração no Mac",
    description: "Bloquear websites é apenas metade da batalha. Slack, Discord, iMessage e jogos vivem fora do navegador — e o modo Focus do macOS não o impede realmente de os abrir.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
<p>Bloqueou Reddit e Twitter no seu navegador. Está a sentir-se disciplinado. Depois clica em Discord "para verificar uma mensagem" e 30 minutos desaparecem num canal de memes. Ou abre Slack para responder a uma thread e acaba por ler todos os canais em que está.</p>

<p>O bloqueio de websites resolve metade do problema de distração. A outra metade vive na sua pasta de Aplicações.</p>

<h2>Por Que o Modo Focus do macOS Não É Suficiente</h2>
<p>O modo Focus integrado da Apple filtra notificações — pode silenciar pings de aplicações específicas. Mas não o impede de abrir essas aplicações. Pode ainda lançar Discord, Slack, Mensagens ou Steam durante uma sessão "Não Perturbar". O modo Focus oculta os alertas; não bloqueia a fonte.</p>

<p>Isto significa que o modo Focus apenas ajuda com interrupções, não com distrações auto-infligidas. Se é você a abrir a aplicação, o modo Focus não faz nada.</p>

<h2>Lock In! Bloqueia Aplicações e Websites em Conjunto</h2>
...
<h3>Interrupção de Ecrã Inteiro, Não um Toque Suave</h3>
<p>Alguns bloqueadores mostram uma pequena notificação quando abre uma aplicação bloqueada. É fácil dispensar. O painel de interrupção do Lock In! toma conta de todo o ecrã. É impossível ignorar e impossível usar a aplicação bloqueada por trás. Este é o ponto — se o bloqueio é fácil de contornar, não é um bloqueio.</p>

<h3>Combine com Bloqueio de Websites</h3>
<p>O verdadeiro poder é combinar ambos. Bloqueie websites de redes sociais em todos os navegadores através da extensão de sistema e bloqueie aplicações de mensagens e entretenimento através do bloqueador de aplicações. Durante uma sessão Lock In!, cada caminho comum de distração está fechado — navegador e aplicação.</p>

<h3>Listas Predefinidas o Colocam a Começar</h3>
<p>Lock In! inclui listas de bloqueio predefinidas para categorias comuns de distração: Redes Sociais, Entretenimento, Notícias e Compras. Estas cobrem websites populares e pode adicionar aplicações específicas ao lado delas. Construa uma lista de bloqueio uma vez e reutilize-a a cada sessão.</p>

<p>Block the apps, not just the notifications. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "mac-screen-time-website-blocking-limitations": {
    slug: "mac-screen-time-website-blocking-limitations",
    title: "Mac Screen Time Website Blocking Is Broken — Here's Why",
    description: "Screen Time on Mac promises website limits, but it only works in Safari, can be dismissed with a click, and breaks regularly with macOS updates.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
<p>Se tentou usar Screen Time no seu Mac para bloquear websites distrativos, já descobriu a frustração. A Apple construiu Screen Time principalmente para controlo parental em iPhones. A versão Mac é uma reflexão tardia, e as suas funcionalidades de bloqueio de websites refletem isso.</p>
...
<p>Stop fighting Screen Time's limitations. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Give your Pomodoros actual teeth. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>The only blocker that works is one you can't turn off. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Take YouTube off the table during work hours. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Same philosophy, modern execution. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>One app, every distraction, zero loopholes. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Less scrolling, more shipped work. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Notifications quiet is a start. Sites actually blocked is the difference. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Switching browsers shouldn't be a loophole. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "block-reddit-mac": {
...
<p>The scroll ends where the block starts. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>What gets measured gets repeated. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Restriction that's built for you, not for a kid's account you're borrowing. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
  "deep-work-app-mac": {
...
<p>Two protected hours beat six fragmented ones. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Stay informed on your schedule, not the news cycle's. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>The same core promise, built for the Mac you're actually using. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>System-wide means system-wide. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>A block that only works when you don't need it isn't a block. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Keep the cart empty until the workday's done. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>One session, timer and block together. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Remove the option, not just the reminder. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
...
<p>Set it up once, let it run every day after. <a href="https://apps.apple.com/app/lockin/id6802325423">Obtenha Lock In! na Mac App Store</a></p>
`,
  },
};
