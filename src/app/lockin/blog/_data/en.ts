...
export const enArticles: ArticleSet = {
  "block-distracting-websites-mac": {
    ...
    title: "How to Block Distracting Websites on Mac",
    description:
      "You open your browser to check one thing and 40 minutes later you're deep in a Reddit thread. macOS doesn't ship with a real website blocker — here's how to fix that.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "website-blocker-focus-mac": {
    ...
    title: "Best Website Blocker for Focus on Mac",
    description:
      "Browser extensions are easy to disable, Screen Time only covers Safari, and hosts-file hacks need Terminal. A system-level blocker that works across every browser is the missing piece.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "block-tiktok-mac": {
    ...
    title: "How to Block TikTok on Mac During Work",
    description:
      "TikTok's algorithm is designed to keep you scrolling indefinitely. When it's one tab away from your work, willpower alone isn't enough.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "cold-turkey-alternative-mac": {
    ...
    title: "Cold Turkey Alternative for Mac",
    description:
      "Cold Turkey is powerful but Windows-first, and the Mac version has long lagged behind. A native macOS alternative that uses system extensions can fill that gap.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "block-apps-during-focus-mac": {
    ...
    title: "How to Block Apps During Focus Sessions on Mac",
    description:
      "Blocking websites is only half the battle. Slack, Discord, iMessage, and games live outside the browser — and macOS Focus mode doesn't actually prevent you from opening them.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-screen-time-website-blocking-limitations": {
    ...
    description:
      "Screen Time on Mac promises website limits, but it only works in Safari, can be dismissed with a click, and breaks regularly with macOS updates.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "pomodoro-website-blocker-mac": {
    ...
    description:
      "The Pomodoro technique falls apart when your 25-minute focus sprint includes a 10-minute detour to Instagram. A timer alone isn't enough — you need blocking during each interval.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "strict-mode-website-blocker-mac": {
    ...
    description:
      "Every website blocker has a cancel button — and your future self will use it. A strict mode that removes the option entirely is the only version that works long-term.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "block-youtube-mac-during-work": {
    ...
    description:
      "YouTube's autoplay and recommendation sidebar turn a quick lookup into an hour-long detour. Blocking it during work requires something stronger than closing the tab.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "selfcontrol-alternative-mac": {
    ...
    description:
      "SelfControl is a beloved open-source blocker, but it hasn't kept up with modern macOS. No app blocking, no menu bar UI, and compatibility issues with recent system updates.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "focus-app-blocks-websites-and-apps-mac": {
    ...
    description:
      "Most focus tools block websites or apps, not both. Distractions don't respect that boundary — they live in your browser and your dock.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "block-social-media-mac": {
    ...
    description:
      "Instagram, X, and TikTok are engineered to pull you back in. Here's a practical setup for keeping them out of your workday without relying on willpower.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-focus-mode-doesnt-block-websites": {
    ...
    description:
      "Apple's Focus feature silences notifications but leaves your browser wide open. If you assumed it blocked distracting sites too, here's the gap and how to close it.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "website-blocker-all-browsers-mac": {
    ...
    description:
      "Most blocker extensions only cover the one browser they're installed in. If you switch browsers to dodge a block, here's a setup that closes that loophole.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "block-reddit-mac": {
    ...
    description:
      "Reddit's infinite scroll and endless subreddits make it one of the easiest ways to lose an afternoon. Here's how to keep it out of your workday specifically.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "focus-app-with-stats-mac": {
    ...
    description:
      "Most blockers just block. Without a record of your focus time, it's hard to know if the habit is actually improving — here's a setup that tracks it for you.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-parental-controls-for-yourself": {
    ...
    description:
      "Screen Time is built for managing a child's account, but plenty of adults set it up on their own Mac hoping for the same effect. Here's why that's awkward, and a better fit.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "deep-work-app-mac": {
    ...
    description:
      "Deep work requires uninterrupted stretches of time, but a single ping or open tab can end a session before it starts. Here's how to protect the block properly.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "block-news-sites-mac": {
    ...
    description:
      "Checking the news 'for a minute' during work rarely stays a minute — headlines are designed to pull you into the next story. Here's how to keep it out of your work blocks.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "freedom-app-alternative-mac": {
    ...
    description:
      "Freedom pioneered the subscription website blocker, but a recurring fee for basic blocking has pushed a lot of people to look for a simpler, native option.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "mac-website-blocker-system-wide": {
    ...
    description:
      "A block that only covers one browser isn't really a block, it's a suggestion. Here's what a truly system-wide setup looks like on Mac.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "unbypassable-website-blocker-mac": {
    ...
    description:
      "A blocker you can disable in one click isn't a blocker, it's a reminder. Here's how to set up a block that holds even when you really want it to stop.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "block-online-shopping-mac": {
    ...
    description:
      "A quick browse of Amazon or a clothing site during work rarely stays quick, and it tends to end with a cart full of things you didn't plan to buy. Here's how to keep it out of your workday.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "focus-timer-with-website-blocking-mac": {
    ...
    description:
      "A timer alone doesn't stop you from opening a distracting tab, and a blocker alone doesn't give your work session structure. Here's what it looks like combined.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-productivity-apps-for-adhd": {
    ...
    description:
      "Standard productivity advice often assumes you'll remember to avoid distractions. For an ADHD brain, the more reliable fix is removing the option entirely.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "schedule-website-blocking-mac": {
    ...
    description:
      "Manually starting a blocker every morning is one more thing to remember, and the days you forget are usually the days you needed it most. Here's how to automate it.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
