...
const APP_STORE_URL = "https://apps.apple.com/app/lockin/id6802325423";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Lock In! — Website Blocker Blog",
    description: "Block distracting websites and apps during focus sessions — system-wide.",
  };
}
...
export default async function LockinBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#FF3B30] mb-5">
          Lock In! — Website Blocker
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#FF3B3066", background: "#FF3B3014" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Lock In!</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#FF3B30] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
