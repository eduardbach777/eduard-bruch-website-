...
export const trArticles: ArticleSet = {
  "best-developer-tools-app-mac": {
    ...
    title: "Mac İçin En İyi Geliştirici Araçları Uygulaması",
    description: "Tarayıcı sekmeler, CLI betikleri ve yer imleri klasörleri arasında geçiş yapmak, temel dev araçları için gerçek kodlamadan daha fazla zaman harcatır.",
    date: "2026-09-06",
    readTime: "5 dk okuma",
    content: `
...
`,
  ...
  "json-formatter-mac-app": {
    ...
    title: "Mac İçin JSON Biçimlendiricisi — Yerel Uygulama, Çevrimdışı Çalışır",
    description: "Biçimlendirilmemiş JSON'u bir tarayıcı aracına yapıştırmak, haftada düzinelerce kez sorgusuz sormasız tekrar ettiğiniz bir iş akışıdır.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "base64-encoder-decoder-mac": {
    ...
    title: "Mac İçin Base64 Kodlayıcı ve Kodunu Çözücü",
    description: "Base64 dizelerini Terminal komutları veya web araçlarıyla kodunu çözmek, günlüklerde veya yapılandırmalarda kodlanmış bir değerle karşılaştığınız her zaman akışınızı keserek etkiler.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "devtoys-alternative-mac": {
    ...
    title: "Mac İçin DevToys Alternatifi",
    description: "DevToys, hepsinde bir geliştirici araç kiti fikrini Windows'a getirdi, ancak macOS sürümü hiçbir zaman Mac kullanıcılarının beklediği yerel deneyimi eşleştiremedi.",
    date: "2026-09-06",
    readTime: "5 dk okuma",
    content: `
...
`,
  ...
  "jwt-decoder-mac": {
    ...
    title: "Mac İçin JWT Çözücüsü — Yapıştırın ve İnceyin",
    description: "JWT'leri jwt.io'ya yapıştırmak bunların taleplerini okumak için işe yarar, ta ki canlı bir tokenı üçüncü taraf web sitesine gönderdiğinizi fark edene kadar.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "url-encoder-decoder-mac": {
    ...
    title: "Mac İçin URL Kodlayıcı ve Kodunu Çözücü",
    description: "%20 ve %3D dolu yüzde kodlu URL'leri okumak, her boşluğun sayıyla değiştirildiği bir cümleyi okumak gibidir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "hash-generator-mac-app": {
    ...
    title: "Mac İçin Hash Oluşturucu — MD5, SHA-256 ve Daha Fazlası",
    description: "Dosya bütünlüğünü doğrulamak veya parola hashlarını oluşturmak Terminal komutları aracılığıyla, her seferinde her algoritma için farklı bayrakları hatırlamayı anlamına gelir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "regex-tester-mac-app": {
    ...
    title: "Mac İçin Regex Test Cihazı — Yerel ve Çevrimdışı",
    description: "Canlı geri bildirim olmadan normal ifadeler yazmak, sözdizimi vurgulaması olmadan kod düzenlemek gibidir — teknik olarak mümkün, ama gereksiz yere acı vericidir.",
    date: "2026-09-06",
    readTime: "5 dk okuma",
    content: `
...
`,
  ...
  "color-picker-hex-rgb-mac": {
    ...
    title: "Mac İçin Renk Seçici — Hex ve RGB",
    description: "Onaltılık kodlar, RGB değerleri ve HSL notasyonu arasında el ile dönüşüm yapmak, günde birden çok kez yapıyorsanız hata yapması kolay ve gereksizdir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "uuid-generator-mac": {
    ...
    title: "Mac İçin UUID Oluşturucu — Anında Kopyala",
    description: "UUID'leri Terminal aracılığıyla veya kod parçacıkları aracılığıyla oluşturmak, tamamen önemsiz olması gereken bir göreve sürtünme ekler.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "all-in-one-dev-tools-mac-offline": {
    ...
    title: "Mac İçin Hepsinde Bir Geliştirici Araçları — 41 Araç, Tamamen Çevrimdışı",
    description: "Kodlama için tarayıcı sekmeler, hashing için Terminal pencereleri, biçimlendirme için yer imleri — geliştirici mikro görevleri düzinelerce yere dağılmıştır.",
    date: "2026-09-06",
    readTime: "5 dk okuma",
    content: `
...
`,
  ...
  "json-validator-mac-app": {
    ...
    title: "Mac İçin JSON Doğrulayıcı — Hataları Anında Bulun",
    description: "Eksik virgül veya seçkili ayraç tüm yapılandırma dosyasını kırar ve satır satır tarayan harcanan zaman yoktur.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "html-entity-encoder-mac": {
    ...
    title: "Mac İçin HTML Varlık Kodlayıcı ve Kodunu Çözücü",
    description: "Kullanıcı tarafından gönderilen metni güvenli şekilde oluşturmak veya ve &amp; &lt; dolu sayfa kaynak okuması, aynı can sıkıcı dönüştürme sorununa kaynaklanır.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "timestamp-converter-mac": {
    ...
    title: "Mac İçin Unix Zaman Damgası Dönüştürücüsü",
    description: "Günlük satırı 1743984000 oku ve kafanızda matematik yapmadan üç saat veya üç hafta önce olup olmadığını bilmek gerekiyor.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "markdown-preview-mac-app": {
    ...
    title: "Mac İçin Markdown Ön İzlemesi — Yapıştırın ve Görün",
    description: "README veya çekme isteği açıklaması ham Markdown'da yazma başlıkları, listeler ve kod blokları gerçekte nasıl oluşturacağı tahmin anlamına gelir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "lorem-ipsum-generator-mac": {
    ...
    title: "Mac İçin Lorem Ipsum Oluşturucu — Her Uzunluk Kopyala",
    description: "Yer tutucu metinle tasarım mock-up veya test demeti doldurma web sitesini her seferinde başında başında gitmelidir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "xml-formatter-mac": {
    ...
    title: "Mac İçin XML Biçimlendiricisi ve Doğrulayıcı",
    description: "SOAP yanıtları ve eski yapılandırma dosyaları hala gibi biçimlendirilmemiş XML gelir ve okuması biçimlendirme düzleştirme sabit gereklidir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "cron-expression-helper-mac": {
    ...
    title: "Mac İçin Cron İfadesi Yardımcı",
    description: "Yazma bir zamanlama ifadesi el veya ummak bu ne anlamı olup 3 öğleden sonra yerine 3'te saat çalıştırılan tüm işlemler nasıl olup.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "yaml-to-json-mac": {
    ...
    title: "Mac İçin YAML'dan JSON'a Dönüştürücüsü",
    description: "YAML yapılandırmasını JSON'a dönüştürmek veya bunun tersini yapmak, elle yeniden yazma olmadan platformlar arasında geçiş yapmak anlamına gelir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "text-diff-tool-mac": {
    ...
    title: "Mac İçin Metin Farkı Aracı",
    description: "İki metin bloğunu karşılaştırmak el ile satır satır okumak yerine farkları vurgulayan bir araç gerekir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "number-base-converter-mac": {
    ...
    title: "Mac İçin Sayı Tabanı Dönüştürücüsü",
    description: "Onaltılık, ikili ve sekizli arasında dönüştürmek, kodda sabit değerlerle çalışırken sık gerekli ancak kafanızda hesaplamak zordur.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "csv-to-json-mac": {
    ...
    title: "Mac İçin CSV'den JSON'a Dönüştürücü",
    description: "CSV veri dosyasını JSON'a dönüştürmek, elle yeniden yapılandırma yerine otomatik olmayı hak eder.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "mac-developer-tools-no-internet": {
    ...
    title: "İnternet Olmadan Mac Geliştirici Araçları",
    description: "Çevrimdışı çalışırken geliştirici araçlarına güvenmek ağ bağlantısı olmadığında mümkün olmalıdır.",
    date: "2026-09-06",
    readTime: "5 dk okuma",
    content: `
...
`,
  ...
  "clipboard-formatter-mac": {
    ...
    title: "Mac İçin Pano Biçimlendiricisi",
    description: "Panonuzdaki metni otomatik olarak biçimlendirmek kopyala-yapıştır yolculuklarını azaltır.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "string-escape-unescape-mac": {
    ...
    title: "Mac İçin Dize Kaçışı ve Kaçışını Kaldır",
    description: "Dizeleri kaçış karakterleriyle kodlamak ve çözmek, program kodlarında ve yapılandırmalarda sık gereklidir.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
...
`,
  ...
  "mac-developer-utility-menu-bar": {
    ...
    title: "Mac Geliştirici Yardımcı Programı Menü Çubuğu",
    description: "Geliştirici araçları menü çubuğunuzda yaşamalı, böylece her zaman dakikalar sonra erişilebilir ve asla saklı kalmamalıdır.",
    date: "2026-09-06",
    readTime: "4 dk okuma",
    content: `
