...
export const itArticles: ArticleSet = {
  "best-media-converter-mac": {
    ...
    title: "Il miglior convertitore multimediale per Mac",
    description: "Destreggiarsi tra app separate per la conversione di video, immagini e audio spreca tempo. Un singolo strumento nativo gestisce tutti e tre i tipi di media in una finestra.",
    date: "2026-09-06",
...
`,
  ...
  "batch-convert-images-mac": {
    ...
    title: "Come convertire immagini in batch su Mac",
    description: "Convertire immagini una alla volta in Preview è noioso. Ci sono modi più veloci per convertire in batch centinaia di foto tra formati su macOS.",
    date: "2026-09-06",
    readTime: "5 min di lettura",
    content: `
...
`,
  ...
  "permute-alternative-mac": {
    ...
    title: "Alternativa a Permute per Mac",
    description: "Cercate un convertitore multimediale che gestisca video, immagini e audio senza abbonamento. Un'app macOS nativa con elaborazione batch e una pipeline pixel.",
    date: "2026-09-06",
...
`,
  ...
  "heic-to-jpg-batch-mac": {
    ...
    title: "Come convertire HEIC in JPG in batch su Mac",
    description: "Centinaia di foto HEIC dal vostro iPhone che nulla al di fuori dell'ecosistema Apple può aprire. La conversione in batch a JPG dovrebbe essere semplice.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "video-converter-mac-native": {
    ...
    title: "Convertitore video nativo per Mac, senza Electron",
    description: "I convertitori basati su Electron mangiano RAM e fanno girare le ventole. Un convertitore video nativo macOS utilizza l'accelerazione hardware e rimane leggero.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "convert-webp-to-png-mac": {
    ...
    title: "Come convertire WebP in PNG su Mac in blocco",
    description: "Scaricate una cartella di immagini WebP e nulla le apre correttamente. Conversione in blocco a PNG su macOS senza un caricamento Web.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "resize-images-batch-mac": {
    ...
    title: "Come ridimensionare immagini in batch su Mac",
    description: "Ridimensionare le foto una alla volta in Preview è un'operazione dispendiosa. Ridimensionamento in batch di centinaia di immagini alle dimensioni esatte su macOS senza Photoshop.",
    date: "2026-09-06",
    readTime: "5 min di lettura",
    content: `
...
`,
  ...
  "convert-mov-to-mp4-mac": {
    ...
    title: "Come convertire MOV in MP4 su Mac",
    description: "Le registrazioni dello schermo e i video dell'iPhone vengono salvati come MOV. La maggior parte delle piattaforme vuole MP4. Conversione senza ricodifica o perdita di qualità su macOS.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "add-watermark-batch-images-mac": {
    ...
    title: "Come aggiungere una filigrana alle immagini in batch su Mac",
    description: "Applicare un logo a centinaia di foto una alla volta è brutale. Applicazione di filigrana in batch su macOS con controllo della posizione e della pipeline.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "handbrake-alternative-mac-images-too": {
    ...
    title: "Alternativa a HandBrake per Mac che gestisce anche immagini",
    description: "HandBrake è ottimo per i video ma non tocca le immagini. Un convertitore macOS che gestisce video, immagini e audio in uno strumento.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "mp3-converter-mac": {
    ...
    title: "Convertitore MP3 per Mac, audio, video e immagini in una sola app",
    description: "L'esportazione di MP3 su macOS di solito significa installare ffmpeg o un'app gratuita dubbia. Un convertitore nativo con un encoder LAME integrato.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "convert-png-to-jpg-batch-mac": {
    ...
    title: "Come convertire PNG in JPG in batch su Mac",
    description: "Gli screenshot e le esportazioni di design si accumulano rapidamente come PNG. Ecco come trasformare un'intera cartella in JPG su macOS senza aprire ogni file.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "compress-images-batch-mac": {
    ...
    title: "Come comprimere immagini in batch su Mac",
    description: "Le cartelle di foto grandi rallentano i caricamenti e mangiano lo storage. Ecco come ridurre centinaia di immagini contemporaneamente su macOS senza farlo manualmente.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "convert-mkv-to-mp4-mac": {
    ...
    title: "Come convertire MKV in MP4 su Mac",
    description: "I file MKV non verranno riprodotti in QuickTime o caricati correttamente sulla maggior parte delle piattaforme. Ecco come convertirli in MP4 su macOS senza installare ffmpeg.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "mac-preview-batch-convert-limitations": {
    ...
    title: "Limitazioni della conversione batch in Preview su Mac, cosa non può fare",
    description: "Preview può tecnicamente convertire più immagini contemporaneamente, ma la funzione ha veri punti deboli. Ecco cosa fa bene e dove è carente.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "convert-tiff-to-jpg-mac": {
    ...
    title: "Come convertire TIFF in JPG su Mac",
    description: "I TIFF da scanner e fotocamere sono enormi e spesso non supportati dagli strumenti Web. Ecco come convertirli in JPG su macOS, un file o un intero batch.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "image-resizer-mac-app": {
    ...
    title: "Ridimensionatore di immagini per Mac, ridimensiona in batch senza Photoshop",
    description: "Ridimensionare un manipolo di foto in Preview va bene. Ridimensionare centinaia per un sito Web o un annuncio di negozio ha bisogno di uno strumento batch reale, non di azioni Photoshop.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "convert-audio-files-mac": {
    ...
    title: "Come convertire file audio su Mac, WAV, FLAC, MP3, AAC",
    description: "I voice memo, l'audio estratto e le esportazioni di podcast raramente arrivano nel formato di cui hai effettivamente bisogno. Ecco come convertire tra WAV, FLAC, MP3 e AAC su macOS.",
    date: "2026-09-06",
    readTime: "5 min di lettura",
    content: `
...
`,
  ...
  "crop-images-batch-mac": {
    ...
    title: "Come ritagliare immagini in batch su Mac",
    description: "Ritagliare cento foto di prodotti allo stesso rapporto di aspetto una alla volta è uno spreco di pomeriggio. Ecco come ritagliare in batch su macOS.",
    date: "2026-09-06",
    readTime: "4 min di lettura",
    content: `
...
`,
  ...
  "ffmpeg-alternative-mac-gui": {
    ...
    title: "Alternativa a FFmpeg per Mac con interfaccia grafica",
...
`,
  ...
  "convert-raw-to-jpg-mac": {
    ...
    title: "Come convertire foto RAW in JPG su Mac",
...
`,
  ...
  "mac-sips-command-vs-gui-converter": {
    ...
    title: "Comando sips di Mac vs convertitore GUI, quando usare ciascuno",
...
`,
  ...
  "reduce-image-file-size-mac": {
    ...
    title: "Come ridurre le dimensioni dei file immagine su Mac senza perdere qualità",
...
`,
  ...
  "convert-gif-to-mp4-mac": {
    ...
    title: "Come convertire GIF in MP4 su Mac",
...
`,
  ...
  "batch-watermark-photos-mac": {
    ...
    title: "Come applicare filigrana in batch alle foto su Mac",
...
`,
  ...
  "convert-avif-to-png-mac": {
    ...
    title: "Come convertire AVIF in PNG su Mac",
