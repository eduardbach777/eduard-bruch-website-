...
export const enArticles: ArticleSet = {
  "best-media-converter-mac": {
    ...
    title: "Best Media Converter for Mac",
    description:
      "Juggling separate apps for video, image, and audio conversion wastes time. A single native tool handles all three media types in one window.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "batch-convert-images-mac": {
    ...
    description:
      "Converting images one at a time in Preview is tedious. There are faster ways to batch-convert hundreds of photos between formats on macOS.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "permute-alternative-mac": {
    ...
    title: "Permute Alternative for Mac",
    description:
      "Looking for a media converter that handles video, images, and audio without a subscription. A native macOS app with batch processing and a pixel pipeline.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "heic-to-jpg-batch-mac": {
    ...
    description:
      "Hundreds of HEIC photos from your iPhone that nothing outside Apple's ecosystem can open. Batch-converting them to JPG should be simple.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "video-converter-mac-native": {
    ...
    description:
      "Electron-based converters eat RAM and spin your fans. A native macOS video converter uses hardware acceleration and stays light.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-webp-to-png-mac": {
    ...
    description:
      "Downloaded a folder of WebP images and nothing opens them properly. Bulk-converting to PNG on macOS without a web uploader.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "resize-images-batch-mac": {
    ...
    description:
      "Resizing photos one by one in Preview is a time sink. Batch resizing hundreds of images to exact dimensions on macOS without Photoshop.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "convert-mov-to-mp4-mac": {
    ...
    description:
      "Screen recordings and iPhone videos save as MOV. Most platforms want MP4. Converting without re-encoding or quality loss on macOS.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "add-watermark-batch-images-mac": {
    ...
    description:
      "Stamping a logo on hundreds of photos one at a time is brutal. Batch watermarking on macOS with position and pipeline control.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "handbrake-alternative-mac-images-too": {
    ...
    description:
      "HandBrake is great for video but doesn't touch images. A macOS converter that handles video, images, and audio in one tool.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mp3-converter-mac": {
    ...
    description:
      "Exporting MP3 on macOS usually means installing ffmpeg or a sketchy free app. A native converter with a bundled LAME encoder.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-png-to-jpg-batch-mac": {
    ...
    description:
      "Screenshots and design exports pile up as PNGs fast. Here's how to turn a whole folder into JPGs on macOS without opening each file.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "compress-images-batch-mac": {
    ...
    description:
      "Large photo folders slow down uploads and eat storage. Here's how to shrink hundreds of images at once on macOS without doing it manually.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-mkv-to-mp4-mac": {
    ...
    description:
      "MKV files won't play in QuickTime or upload cleanly to most platforms. Here's how to convert them to MP4 on macOS without installing ffmpeg.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-preview-batch-convert-limitations": {
    ...
    description:
      "Preview can technically convert multiple images at once, but the feature has real gaps. Here's what it does well and where it falls short.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-tiff-to-jpg-mac": {
    ...
    description:
      "TIFFs from scanners and cameras are huge and often unsupported by web tools. Here's how to convert them to JPG on macOS, one file or a whole batch.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "image-resizer-mac-app": {
    ...
    description:
      "Resizing a handful of photos in Preview is fine. Resizing hundreds for a website or store listing needs a real batch tool, not Photoshop actions.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-audio-files-mac": {
    ...
    description:
      "Voice memos, ripped audio, and podcast exports rarely arrive in the format you actually need. Here's how to convert between WAV, FLAC, MP3, and AAC on macOS.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "crop-images-batch-mac": {
    ...
    description:
      "Cropping a hundred product photos to the same aspect ratio one at a time is a waste of an afternoon. Here's how to batch crop on macOS instead.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ffmpeg-alternative-mac-gui": {
    ...
    description:
      "FFmpeg can do almost anything with media files, but remembering flag syntax for every job gets old. Here's a GUI approach for the conversions people actually need.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-raw-to-jpg-mac": {
    ...
    description:
      "RAW files preserve every detail a camera sensor captures, but almost nothing outside a photo editor can open them. Here's how to convert a shoot's worth to JPG on macOS.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-sips-command-vs-gui-converter": {
    ...
    description:
      "macOS ships a hidden command-line image tool called sips. Here's what it can do, where it struggles, and when a graphical batch converter makes more sense.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "reduce-image-file-size-mac": {
    ...
    description:
      "Big image files slow down websites and clog storage, but aggressive compression makes photos look bad. Here's how to shrink files while keeping quality intact on macOS.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-gif-to-mp4-mac": {
    ...
    description:
      "GIFs are bloated for what they actually contain — short looping video. Here's how to convert them to MP4 on macOS for smaller files and better playback.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "batch-watermark-photos-mac": {
    ...
    description:
      "Stamping a logo onto every photo one at a time doesn't scale past a handful of images. Here's how to watermark a whole batch consistently on macOS.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "convert-avif-to-png-mac": {
    ...
    description:
      "AVIF is a great web format but a poor fit for editing or apps that expect older image types. Here's how to convert it back to PNG on macOS.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
