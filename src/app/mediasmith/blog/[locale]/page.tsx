...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Mediasmith — Media Converter Blog",
    description: "Convert video, images, and audio in batch with a visual pipeline.",
  };
}
...
export default async function MediasmithBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#30D158] mb-5">
          Mediasmith — Media Converter
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#30D15866", background: "#30D15814" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Mediasmith</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#30D158] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
