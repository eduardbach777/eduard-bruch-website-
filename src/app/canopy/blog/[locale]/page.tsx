...
const APP_STORE_URL = "https://apps.apple.com/app/canopy/id6806640970";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Canopy — Disk Space Visualizer Blog",
    description: "See exactly where your disk space goes with an interactive treemap.",
  };
}
...
export default async function CanopyBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#34C759] mb-5">
          Canopy — Disk Space Visualizer
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#34C75966", background: "#34C75914" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Canopy</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#34C759] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
