export const metadata = {
  ...
  description:
    "Terms of service for Canopy - Disk Space Visualizer by Eduard Bruch.",
};

export default function CanopyTerms() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        These Terms of Service (&quot;Terms&quot;) govern your use of Canopy
      ...
      <p className="mb-6">
        Canopy is a macOS utility that scans folders on your Mac and presents
        disk usage as an interactive treemap visualization. The App helps you
        identify large files and find duplicates to free up disk space. The App
      ...
      {/* 3. Disk Analysis Disclaimer */}
      <h2 className="mb-3 mt-10 text-xl font-semibold text-white">
        3. Disk Analysis Disclaimer
      </h2>
      <p className="mb-6 border-l-4 border-amber-500 pl-4 text-neutral-100">
        <strong>
          Canopy is a disk space visualization and duplicate detection tool. It
          does not automatically delete, move, or modify any files.
        </strong>{" "}
        You are solely responsible for any actions you take based on the
        information provided by the App, including deleting files identified as
        duplicates. Eduard Bruch assumes no liability for data loss resulting
        from actions taken based on the App&apos;s analysis.
      </p>

      {/* 4. Accuracy */}
      <h2 className="mb-3 mt-10 text-xl font-semibold text-white">
        4. File Operations Accuracy
      </h2>
      <p className="mb-6">
        While the App uses reliable algorithms for scanning and duplicate
        detection, no software can guarantee absolute accuracy in every
        scenario. Results should be verified independently before deleting
        files, especially when dealing with important data. Always maintain
      ...
      <p className="mb-6">
        Scan results, cached data, and preferences you create within the App
        are stored locally on your device. This content remains your property.
        We have no access to it and assume no responsibility for its
        preservation. Uninstalling the App or clearing its data will permanently
        delete this content.
      </p>
      ...
      <p className="mb-6">
        ...
        errors in disk analysis, duplicate detection, or other information
        provided by the App; (c) any decision made in reliance on the
        App&apos;s output; or (d) any unauthorized access to or loss of your
        locally stored data. In no event shall our total aggregate liability
      ...
      <p className="mb-6">
        ...
        that scan results are complete or that duplicate detection is exhaustive.
