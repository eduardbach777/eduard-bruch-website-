...
const APP_STORE_URL = "https://apps.apple.com/app/dayedge/id6806600925";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Dayedge — Calendar Sidebar Blog",
    description: "Pin a slim calendar timeline to your screen edge — always visible, never in the way.",
  };
}
...
export default async function DayedgeBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#FF9500] mb-5">
          Dayedge — Calendar Sidebar
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#FF950066", background: "#FF950014" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Dayedge</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#FF9500] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
