export const metadata = {
  title: "Privacy Policy — Dayedge",
  description:
    "Privacy policy for Dayedge - Calendar Sidebar by Eduard Bruch. No data collected, no tracking, no analytics.",
};

export default function DayedgePrivacy() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        This privacy policy describes how Dayedge (&quot;the App&quot;),
        published by Eduard Bruch, handles your data. In short:{" "}
        <strong>
      ...
      <p className="mb-4 border-l-4 border-emerald-500 pl-4 font-medium text-white">
        None. Dayedge collects zero personal data.
      </p>
      <p className="mb-6">
        The App is a paid, one-time-purchase macOS utility that displays your
        calendar events on the edge of your screen. It does not require an
        ...
        calendar data is read locally and all preferences are stored exclusively
      ...
      <p className="mb-6">
        The App requests access to your calendar through the macOS Calendar
        permission to read and display your events. All calendar data is
        processed entirely on your device. Event titles, times, and details are
        read solely for display purposes and are never copied, stored separately,
        or transmitted to any server. You can revoke this permission at any time
      ...
      <ul className="mb-6 list-disc pl-6 space-y-2">
        <li>Selected calendars to display</li>
        <li>Sidebar position and display preferences</li>
        <li>App window state and appearance settings</li>
      </ul>
      <p className="mb-6">
      ...
      <p className="mb-6">
        Dayedge does not integrate any third-party services. There are no
      ...
      <p className="mb-6">
        Dayedge requires Calendar access permission to read your events for
        display on the sidebar. This is the only sensitive permission the App
        requests. Calendar data is read locally and never sent anywhere. The App
        does not request access to your camera, microphone, photos, contacts,
        location, or any other sensitive device feature.
      </p>
      ...
      <p className="mb-6">
        If you have opted in to sharing diagnostics with Apple, Apple may collect
        anonymized crash logs and usage statistics. This data is collected by
        Apple, not by Eduard Bruch, and is subject to Apple&apos;s privacy
        policy. You can opt out of Apple diagnostics in System Settings &gt;
      ...
      <p className="mb-6">
        ...
        children. It is safe for use by all ages. We comply with COPPA
        (Children&apos;s Online Privacy Protection Act) and GDPR provisions
        regarding minors.
      </p>
