export const metadata = {
  title: "Terms of Service — Dayedge",
  description:
    "Terms of service for Dayedge - Calendar Sidebar by Eduard Bruch.",
};

export default function DayedgeTerms() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-2 text-lg text-neutral-300">
        Dayedge &mdash; Calendar Sidebar
      </p>
      ...
      <p className="mb-6">
        These Terms of Service (&quot;Terms&quot;) govern your use of Dayedge
      ...
      <p className="mb-6">
        Dayedge is a macOS utility that displays your calendar events on a
        sidebar at the edge of your screen. The App reads your calendar data
        through the macOS Calendar permission to show upcoming events at a
        glance. The App is available as a one-time paid purchase with no in-app
      ...
      {/* 3. Disclaimer */}
      <h2 className="mb-3 mt-10 text-xl font-semibold text-white">
        3. Calendar Data Disclaimer
      </h2>
      <p className="mb-6 border-l-4 border-amber-500 pl-4 text-neutral-100">
        <strong>
          Dayedge is a read-only calendar display utility.
        </strong>{" "}
        The App reads and displays calendar events but does not create, modify,
        or delete any events. Calendar data shown in the App is sourced from your
        macOS Calendar and may not reflect real-time changes until the App
        refreshes. Eduard Bruch assumes no liability for missed appointments,
        scheduling conflicts, or any consequences resulting from reliance on the
        App&apos;s display of calendar data.
      </p>

      {/* 4. Calendar Accuracy */}
      <h2 className="mb-3 mt-10 text-xl font-semibold text-white">
        4. Calendar Display Accuracy
      </h2>
      <p className="mb-6">
        While the App is designed to accurately reflect your calendar events, it
        depends on data provided by the macOS Calendar framework. We do not
        warrant that all events will be displayed, that times will be perfectly
        accurate across time zones, or that recurring events will always resolve
        correctly. Always verify important appointments against your primary
      ...
      <p className="mb-6">
        Display preferences, selected calendars, and sidebar settings you
        configure within the App are stored locally on your device. This content
        remains your property. We have no access to it and assume no
        responsibility for its preservation. Uninstalling the App or clearing its
        data will permanently delete this content.
      </p>
      ...
      <p className="mb-6">
        ...
        inaccuracies in calendar event display; (c) any missed appointments or
        scheduling issues; or (d) any unauthorized access to or loss of your
      ...
      <p className="mb-6">
        ...
        particular purpose, and non-infringement. We do not warrant that all
        calendar events will be displayed accurately or completely. We do not
