...
const APP_STORE_URL = buildStoreUrl({
  ...
  appId: "6760895260",
  campaign: campaignFor.blogIndex("fisheye"),
});

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Fisheye Camera - WideEye Blog",
    description: "Live fisheye photo and video camera for iPhone — no clip-on lens.",
  };
}
...
export default async function FisheyeBlogPage({
  params,
}: {
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Fisheye Camera</h2>
