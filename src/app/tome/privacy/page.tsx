export const metadata = {
  title: "Privacy Policy — Tome - SQLite Browser",
  description:
    "Privacy policy for Tome - SQLite Browser for macOS. No analytics, no telemetry, no network calls — your data stays on your Mac.",
};

export default function TomePrivacyPolicy() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-neutral-200">
      ...
      <p className="mb-4 text-sm text-neutral-400">Last updated: August 30, 2026</p>
      ...
      <p className="mb-6">
        Tome (&quot;the App&quot;) is a native macOS SQLite database browser that
        lets you open, browse, edit, and query SQLite databases. The App is
        designed with privacy as a core principle. We take the protection of your
        personal data seriously. This privacy policy explains what data is
        processed when you use the App and on what legal basis.
      </p>
      ...
      <p className="mb-4">
        All database operations occur <strong>entirely locally on your device</strong>.
        Tome reads and writes SQLite files directly on your Mac using the
        bundled SQLite C library. No database content is ever transmitted to any
        external server. The legal basis is Art. 6(1)(b) DSGVO (performance of a
        contract / provision of the service).
      </p>
      ...
      <p className="mb-4">
        ...
        window positions, recent files, and appearance settings.
      </p>

      <h3 className="mb-2 mt-4 font-medium text-white">3.3 No Network Requests</h3>
      <p className="mb-4">
        Tome makes <strong>zero network requests</strong>. The App does not
      ...
      <h3 className="mb-2 mt-4 font-medium text-white">3.5 Your Database Files</h3>
      <p className="mb-6">
        Tome accesses database files only when you explicitly open them via the
        file picker or drag-and-drop. File contents are never copied outside the
        app&apos;s sandbox or transmitted anywhere. The App cannot browse your
        filesystem or access files you have not opened.
      </p>
      ...
      <p className="mb-6">
        Tome is distributed through the Mac App Store. All purchases and payment
        processing are handled entirely by Apple. We do not have access to your
        payment information, Apple ID, or purchase history.
      </p>
      ...
      <p className="mb-6">
        ...
        <a
          href="https://eduardbruch.com/tome/privacy"
          className="text-indigo-400 underline"
        >
          eduardbruch.com/tome/privacy
        </a>
