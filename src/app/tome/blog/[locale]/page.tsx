...
const APP_STORE_URL = "https://apps.apple.com/app/tome/id6806639875";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tome — SQLite Browser Blog",
    description: "Browse, query, and edit SQLite databases in a native Mac app.",
  };
}
...
export default async function TomeBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#AF52DE] mb-5">
          Tome — SQLite Browser
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#AF52DE66", background: "#AF52DE14" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Tome</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#AF52DE] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
