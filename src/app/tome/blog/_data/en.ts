...
export const enArticles: ArticleSet = {
  "best-sqlite-browser-mac": {
    ...
    title: "Best SQLite Browser for Mac",
    description:
...
`,
  ...
  "view-sqlite-database-mac": {
    ...
    title: "How to View a SQLite Database on Mac",
    description:
...
`,
  ...
  "native-sqlite-editor-mac": {
    ...
    title: "Native SQLite Editor for Mac — No Electron",
    description:
...
`,
  ...
  "db-browser-alternative-mac": {
    ...
    title: "DB Browser for SQLite Alternative on Mac",
    description:
...
`,
  ...
  "tableplus-alternative-mac-sqlite": {
    ...
    title: "TablePlus Alternative for Mac — SQLite Only",
    description:
...
`,
  ...
  "open-sqlite3-file-mac": {
    ...
    title: "How to Open .sqlite3 Files on Mac Without Terminal",
    description:
...
`,
  ...
  "edit-sqlite-database-mac": {
    ...
    title: "How to Edit a SQLite Database on Mac",
    description:
...
`,
  ...
  "sql-query-editor-mac-native": {
    ...
    title: "SQL Query Editor for Mac — Native and Fast",
    description:
...
`,
  ...
  "browse-core-data-sqlite-mac": {
    ...
    title: "How to Browse Core Data SQLite Files on Mac",
    description:
...
`,
  ...
  "sqlite-viewer-mac-document-based": {
    ...
    title: "SQLite Viewer for Mac — Open Multiple Databases Side by Side",
    description:
...
`,
  ...
  "inspect-app-database-mac": {
    ...
    title: "How to Inspect an App's Database on Mac",
    description:
...
`,
  ...
  "sqlite-for-ios-developers-mac": {
    ...
    title: "SQLite Browser for iOS Developers on Mac",
    description:
...
`,
  ...
  "view-firefox-history-sqlite-mac": {
    ...
    title: "How to View Firefox History (SQLite) on Mac",
    description:
...
`,
  ...
  "sqlite-vs-realm-browser-mac": {
    ...
    title: "SQLite vs Realm Browser on Mac",
    description:
...
`,
  ...
  "mac-sqlite-command-line-vs-gui": {
    ...
    title: "Mac SQLite: Command Line vs GUI — When to Use Each",
    description:
...
`,
  ...
  "edit-sqlite-without-sql-mac": {
    ...
    title: "How to Edit SQLite Without Writing SQL on Mac",
    description:
...
`,
  ...
  "sqlite-database-viewer-apple-silicon": {
    ...
    title: "SQLite Database Viewer Optimized for Apple Silicon",
    description:
