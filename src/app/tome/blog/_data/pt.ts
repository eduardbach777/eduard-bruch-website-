...
export const ptArticles: ArticleSet = {
  "best-sqlite-browser-mac": {
    ...
    title: "Melhor Navegador SQLite para Mac",
    description: "A maioria dos navegadores SQLite no Mac são aplicativos Electron multiplataforma que parecem deslocados. Encontrar um que realmente funcione como um app Mac leva mais tempo do que deveria.",
    date: "2026-09-06",
...
`,
  ...
  "view-sqlite-database-mac": {
    ...
    description: "Arquivos SQLite estão em todos os lugares no seu Mac — dados de apps, lojas Core Data, histórico do navegador — mas o macOS não tem uma forma integrada para abri-los e visualizá-los.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "native-sqlite-editor-mac": {
    ...
    description: "Ferramentas de banco de dados baseadas em Electron consomem centenas de megabytes de RAM apenas para mostrar uma tabela. Um editor nativo do macOS muda o significado de leve.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "db-browser-alternative-mac": {
    ...
    title: "Alternativa do DB Browser para SQLite no Mac",
    description: "DB Browser for SQLite funciona, mas sua interface Qt parece alienígena no macOS — atalhos errados, diálogos de arquivo não nativos e nenhuma integração com seu fluxo de trabalho.",
    date: "2026-09-06",
...
`,
  ...
  "tableplus-alternative-mac-sqlite": {
    ...
    description: "TablePlus suporta todos os bancos de dados, o que significa que SQLite nunca recebe atenção completa. Se SQLite é tudo que você precisa, a complexidade extra apenas atrapalha.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "open-sqlite3-file-mac": {
    ...
    description: "Clicar duas vezes em um arquivo .sqlite3 no Mac não faz nada útil. O macOS não reconhece o formato e o Terminal é a única opção integrada.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "edit-sqlite-database-mac": {
    ...
    description: "Editar um banco de dados SQLite no Mac geralmente significa escrever declarações UPDATE no Terminal. Para uma simples mudança de valor, é muita cerimônia.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "sql-query-editor-mac-native": {
    ...
    title: "Editor de Consultas SQL para Mac — Nativo e Rápido",
    description: "Executar consultas SQL contra um banco de dados SQLite no Mac não deveria exigir um IDE pesado ou uma janela de terminal. Um editor de consultas focado é frequentemente tudo que você precisa.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "browse-core-data-sqlite-mac": {
    ...
    title: "Como Navegar em Arquivos SQLite do Core Data no Mac",
    description: "Core Data armazena seus dados em arquivos SQLite, mas a Apple não oferece ferramenta visual para inspecioná-los. Depuração de dados persistidos significa vasculhar recipientes de apps e ler saída SQL bruta.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
...
`,
  ...
  "sqlite-viewer-mac-document-based": {
    ...
    description: "Comparar dados entre dois bancos de dados SQLite geralmente significa alternar entre abas ou executar duas instâncias de sua ferramenta de banco de dados. Existe uma abordagem mais simples.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "inspect-app-database-mac": {
    ...
    title: "Como Inspecionar o Banco de Dados de um App no Mac",
    description: "Aplicativos no seu Mac armazenam dados em arquivos SQLite ocultos enterrados em pastas Library. Inspecionar o que um app realmente salvou significa navegar por caminhos de recipiente e decodificar saída bruta do banco de dados.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "sqlite-for-ios-developers-mac": {
    ...
    title: "Navegador SQLite para Desenvolvedores iOS no Mac",
    description: "Desenvolvimento iOS significa verificar constantemente o que seu app gravou em seu banco de dados local. O Xcode não tem visualizador SQLite integrado, deixando você montar um fluxo de trabalho a partir do Terminal e ferramentas de terceiros.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
...
`,
  ...
  "view-firefox-history-sqlite-mac": {
    ...
    description: "Firefox armazena seu histórico de navegação completo em um banco de dados SQLite chamado places.sqlite. Visualizá-lo fora do navegador significa lidar com arquivos bloqueados e saída SQL bruta.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "sqlite-vs-realm-browser-mac": {
    ...
    title: "SQLite vs Navegador Realm no Mac",
    description: "Aplicativos móveis usam SQLite ou Realm para armazenamento local, mas inspecionar qualquer um no Mac requer uma ferramenta diferente. Escolher o navegador certo depende de qual formato seu app realmente usa.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "mac-sqlite-command-line-vs-gui": {
    ...
    title: "Mac SQLite: Linha de Comando vs GUI — Quando Usar Cada Um",
    description: "A CLI sqlite3 acompanha cada Mac e lida com consultas rápidas, mas falha para navegar, editar e entender esquemas desconhecidos. Saber quando alternar ferramentas economiza tempo.",
    date: "2026-09-06",
    readTime: "5 min de leitura",
    content: `
...
`,
  ...
  "edit-sqlite-without-sql-mac": {
    ...
    description: "Nem todos que precisam alterar um valor em um banco de dados SQLite conhecem SQL. Designers, testadores de QA e gerentes de produto não devem precisar aprender sintaxe UPDATE para um rápido ajuste de dados.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "sqlite-database-viewer-apple-silicon": {
    ...
    description: "Muitas ferramentas de banco de dados ainda rodam pelo Rosetta em Macs Apple Silicon, desperdiçando bateria e desempenho. Uma build ARM nativa faz uma diferença notável para um app mantido aberto o dia todo.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
...
`,
  ...
  "open-whatsapp-backup-sqlite-mac": {
    ...
    title: "Como Abrir Backup do WhatsApp SQLite no Mac",
    description: "WhatsApp armazena histórico de chat em um banco de dados SQLite. Visualizar essas mensagens fora do app — para fins de arquivo, legal ou pessoal — requer extrair e abrir o arquivo de banco de dados.",
    date: "2026-09-06",
    readTime: "4 min de leitura",
    content: `
