...
const APP_STORE_URL = "https://apps.apple.com/app/jetty/id6806639647";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Jetty — Dock Launcher Blog",
    description: "Launch any app from the menu bar — grouped panels, one click.",
  };
}
...
export default async function JettyBlogPage({
  params,
}: {
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Jetty</h2>
