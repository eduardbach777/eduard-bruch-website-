export const metadata = {
  title: "Terms of Service — Jetty",
  description:
    "Terms of service for Jetty - Dock Launcher by Eduard Bruch.",
};

export default function JettyTerms() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        These Terms of Service (&quot;Terms&quot;) govern your use of Jetty
      ...
      <p className="mb-6">
        Jetty is a macOS menu bar utility that lets you create custom dock panels
        for quick access to your favorite applications. The App reads your
        installed applications list to let you organize them into floating dock
        panels. The App is available as a one-time paid purchase with no in-app
      ...
      <p className="mb-6 border-l-4 border-amber-500 pl-4 text-neutral-100">
        <strong>
          Jetty is a convenience utility for organizing application shortcuts.
        </strong>{" "}
        The App does not modify, move, or delete any applications on your system.
        It creates shortcut panels for launching applications. Eduard Bruch
        assumes no liability for any issues arising from launching applications
        through the App.
      </p>
      ...
      <p className="mb-6">
        While the App is designed to work with standard macOS applications, we do
        not warrant compatibility with every application or macOS version. The
        App depends on macOS system APIs that may change with operating system
        updates.
      </p>
      ...
      <p className="mb-6">
        Panel configurations, app assignments, and other content you create
        within the App are stored locally on your device. This content remains
        your property. We have no access to it and assume no responsibility for
        its preservation. Uninstalling the App or clearing its data will
      ...
      <p className="mb-6">
        ...
        errors or issues with application launching; (c) any incompatibility with
      ...
      <p className="mb-6">
        ...
        will be compatible with all macOS versions or applications. We do not
