export const metadata = {
  title: "Terms of Service — Renym",
  description:
    "Terms of service for Renym - Batch File Renamer by Eduard Bruch.",
};

export default function RenymTerms() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        These Terms of Service (&quot;Terms&quot;) govern your use of Renym
      ...
      <p className="mb-6">
        Renym is a macOS utility for batch renaming files. The App lets you drag
        and drop files, build multi-step rename pipelines with actions such as
        find-and-replace, numbering, case conversion, and regular expressions,
        and preview changes before applying them. The App is available as a
        one-time paid purchase with no in-app purchases or subscriptions.
      </p>
      ...
      <p className="mb-6">
        ...
        personal, non-commercial use, in accordance with the Apple Media
        Services Terms and Conditions.
      </p>

      {/* 3. File Renaming Disclaimer */}
      <h2 className="mb-3 mt-10 text-xl font-semibold text-white">
        3. File Renaming Disclaimer
      </h2>
      <p className="mb-6 border-l-4 border-amber-500 pl-4 text-neutral-100">
        <strong>
          Renym is a file renaming tool. While the App provides a preview of
          changes before applying them, you are solely responsible for verifying
          rename operations before execution.
        </strong>{" "}
        Eduard Bruch assumes no liability for data loss or file system issues
        resulting from rename operations performed by the App. Always maintain
        backups of important files before performing batch operations.
      </p>
      ...
      <p className="mb-6">
        While the App uses reliable methods for renaming files, no software can
        guarantee error-free operation in every scenario. Complex rename
        patterns involving regular expressions or special characters should be
        tested on non-critical files first. Always verify the preview before
        applying changes.
      </p>
      ...
      <ul className="mb-6 list-disc pl-6 space-y-2">
        ...
        <li>
          Refunds are handled exclusively by Apple in accordance with Apple&apos;s
          refund policies. Eduard Bruch does not process payments or refunds
          directly.
        </li>
      </ul>
      ...
      <p className="mb-6">
        The App, including its design, code, graphics, icons, and user
        interface, is the intellectual property of Eduard Bruch and is protected
        by applicable copyright and intellectual property laws. You may not
        copy, modify, distribute, reverse engineer, decompile, or create
        derivative works of the App, except as expressly permitted by applicable
        law.
      </p>
      ...
      <p className="mb-6">
        Rename pipelines, presets, and preferences you create within the App are
        stored locally on your device. This content remains your property. We
      ...
      <p className="mb-6">
        ...
        to reverse engineer, decompile, or disassemble the App; (c)
        circumvent any technical limitations or protections of the App; or (d)
      ...
      <p className="mb-6">
        ...
        errors in file renaming or other operations performed by the App; (c)
        any decision made in reliance on the App&apos;s output; or (d) any
        unauthorized access to or loss of your locally stored data. In no event
        shall our total aggregate liability exceed the amount you paid for the
        App.
      </p>
      ...
      <p className="mb-6">
        ...
        that rename operations will be error-free in every scenario. We do not
      ...
      <p className="mb-6">
        ...
        changes constitutes acceptance of the updated Terms. For material
