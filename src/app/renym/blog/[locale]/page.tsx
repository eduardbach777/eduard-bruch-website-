...
const APP_STORE_URL = "https://apps.apple.com/app/renym/id6806640534";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Renym — Batch File Renamer Blog",
    description: "Rename hundreds of files with visual pipelines — regex, numbering, case changes.",
  };
}
...
export default async function RenymBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#7C5CFC] mb-5">
          Renym — Batch File Renamer
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#7C5CFC66", background: "#7C5CFC14" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Renym</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#7C5CFC] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
