...
import { LOCALE_CODES, BACK_LABEL, NEXT_ARTICLE } from "@/lib/locales";
...
export default async function TarotArticlePage({
  params,
}: {
  params: Promise<{ locale: string; slug: string }>;
}) {
    ...
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      ...
      <div className="px-6 max-w-4xl mx-auto mb-6">
        ...
        >
          ...
          <div className="relative flex items-center justify-between gap-4 px-6 py-5 sm:px-8">
            <div>
              <span className="text-[15px] font-semibold text-white">Aurum Tarot</span>
              <span className="block mt-1 text-[13px] text-neutral-400">Tarot card meanings, spreads, and how-to guides.</span>
            </div>
            <span
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-white tracking-tight">Aurum Tarot</h2>
            ...
            >
              Get Aurum Tarot on Google Play
      ...
      <footer className="px-6 py-10 max-w-4xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <Link href="/tarot/privacy" className="hover:text-white transition">Privacy</Link>
          <Link href="/tarot/terms" className="hover:text-white transition">Terms</Link>
        </nav>
      </footer>
    </main>
  );
