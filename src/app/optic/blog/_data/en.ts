...
export const enArticles: ArticleSet = {
  "copy-text-from-image-mac": {
    ...
    title: "How to Copy Text from an Image on Mac",
    description:
      "You have text trapped inside an image — a photo of a whiteboard, a scanned document, a meme — and no way to select it. Here's how to pull it out instantly.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "screen-ocr-mac": {
    slug: "screen-ocr-mac",
    title: "Screen OCR for Mac — Select and Copy Any Text",
    description:
      "Text on your screen that you can't select or copy — inside images, videos, dialogs, or locked interfaces. A screen-level OCR tool fixes that.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "extract-text-from-screenshot-mac": {
    ...
    title: "How to Extract Text from a Screenshot on Mac",
    description:
      "You took a screenshot to save some text, but now you need that text as actual characters you can edit and search. Retyping it defeats the purpose.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-text-non-selectable-pdf-mac": {
    ...
    title: "How to Copy Text from a Non-Selectable PDF on Mac",
    description:
      "Some PDFs look like normal documents but won't let you select a single word. The text is there visually, but it's trapped as a flat image layer.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "qr-code-reader-mac": {
    ...
    title: "QR Code Reader for Mac — Scan from Screen",
    description:
      "A QR code appears on your Mac screen — in an email, a document, a web page — and your only scanner is the phone in your pocket. There's a faster way.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ocr-text-from-video-mac": {
    ...
    title: "How to OCR Text from a Video or Stream on Mac",
    description:
      "A tutorial shows a terminal command, a stream flashes a URL, a lecture displays a formula — and you can't pause fast enough to type it all out.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-error-message-from-dialog-mac": {
    ...
    title: "How to Copy Error Messages from Dialogs on Mac",
    description:
      "An error dialog pops up with a technical message and no copy button. You're left retyping gibberish error codes just to search for a fix.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-live-text-limitations": {
    ...
    title: "Mac Live Text Limitations — What It Can't Do",
    description:
      "Apple's Live Text works in a few places but silently fails in many others. If you rely on it for screen OCR, you'll hit walls fast.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "textsniper-alternative-mac": {
    ...
    title: "TextSniper Alternative for Mac",
    description:
      "Looking for a screen OCR tool that goes beyond basic text capture — with QR scanning, capture history, and text-to-speech built in.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-code-from-screenshot-mac": {
    ...
    title: "How to Copy Code from a Screenshot on Mac",
    description:
      "A tutorial, a tweet, or documentation shows code as an image. Retyping it introduces bugs. Here's how to extract it as selectable text.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "read-text-aloud-from-screen-mac": {
    ...
    title: "Read Text Aloud from Any Screen Content on Mac",
    description:
      "You want to hear text on your screen read aloud — from an image, a locked document, a video frame — but your Mac's built-in speech only works on selectable text.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ocr-receipts-mac": {
    ...
    title: "OCR Receipts on Mac — Extract Text from Photos of Receipts",
    description:
      "You photographed a receipt for expense reporting, but now you need the vendor name, total, and date as copyable text — not a photo you have to retype from.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-text-from-zoom-screenshare-mac": {
    ...
    title: "How to Copy Text from a Zoom Screen Share on Mac",
    description:
      "A colleague shares their screen on Zoom showing a URL, a config, or data — but you can only watch, not select or copy any of the text you're seeing.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-screenshot-to-text": {
    ...
    title: "Mac Screenshot to Text — Extract Words from Any Capture",
    description:
      "You take screenshots constantly, but turning those captures into editable, searchable text still requires retyping everything you see.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-serial-number-from-image-mac": {
    ...
    title: "How to Copy a Serial Number from an Image on Mac",
    description:
      "A serial number sits in a photo or scan — long, alphanumeric, impossible to retype without errors. You need it as copyable text, not pixels.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ocr-handwriting-mac": {
    ...
    title: "OCR Handwriting on Mac — Convert Written Notes to Text",
    description:
      "You photographed handwritten notes — from a whiteboard, a notebook, or a sticky note — and need the words as editable digital text.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-text-recognition-menu-bar": {
    ...
    title: "Text Recognition from the Mac Menu Bar",
    description:
      "You need quick text recognition without opening a full app, importing files, or disrupting your workflow — just a fast grab from whatever is on screen.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-text-from-youtube-video-mac": {
    ...
    title: "How to Copy Text from a YouTube Video on Mac",
    description:
      "A YouTube video displays a command, a link, or a piece of information you need — but the video player won't let you select any text from the video frame.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "scan-qr-code-from-screenshot-mac": {
    ...
    title: "How to Scan a QR Code from a Screenshot on Mac",
    description:
      "You have a screenshot of a QR code on your Mac, but no way to scan it — your phone camera can't read a screen, and macOS offers no built-in decoder.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ocr-foreign-language-mac": {
    ...
    description:
      "Text in a foreign language appears on screen — in an image, a document, or a video — and you need to copy it even though you can't type those characters yourself.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-text-from-slack-image-mac": {
    ...
    description:
      "A teammate shares a screenshot in Slack — an error log, a config, a dashboard — and the text inside it is just pixels you can't copy or search.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "mac-preview-ocr-limitations": {
    ...
    description:
      "Preview handles images and PDFs but can't extract text from most of them. If you've tried to copy text from a scanned PDF or photo in Preview and got nothing, here's why.",
    date: "2026-09-06",
    readTime: "5 min read",
    content: `
...
`,
  ...
  "batch-ocr-screenshots-mac": {
    ...
    description:
      "You have a collection of screenshots containing text you need — but processing them one by one through a traditional OCR tool is tedious and slow.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "copy-address-from-image-mac": {
    ...
    description:
      "A delivery label, a business card photo, or a scanned letter contains an address you need — but it's trapped in an image with no way to select it.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
...
`,
  ...
  "ocr-code-snippets-mac": {
    ...
    description:
      "Code appears as an image in a tutorial, documentation, or a shared screenshot — and retyping it means introducing bugs one misplaced character at a time.",
    date: "2026-09-06",
    readTime: "4 min read",
    content: `
