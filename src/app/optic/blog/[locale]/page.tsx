...
const APP_STORE_URL = "https://apps.apple.com/app/optic/id6806597766";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Optic — Screen OCR Blog",
    description: "Select any text on screen and copy it — images, PDFs, dialogs, anything.",
  };
}
...
export default async function OpticBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#007AFF] mb-5">
          Optic — Screen OCR
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#007AFF66", background: "#007AFF14" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Optic</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#007AFF] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
