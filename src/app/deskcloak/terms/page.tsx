export const metadata = {
  title: "Terms of Service — DeskCloak",
  description:
    "Terms of service for DeskCloak - Desktop Privacy Screen by Eduard Bruch.",
};

export default function DeskcloakTerms() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        These Terms of Service (&quot;Terms&quot;) govern your use of DeskCloak
      ...
      <p className="mb-6">
        DeskCloak is a macOS utility that hides your desktop icons by placing a
        blur or wallpaper overlay on top of them, giving you a clean and private
        desktop view. The App is available as a one-time paid purchase with no
      ...
      <p className="mb-6 border-l-4 border-amber-500 pl-4 text-neutral-100">
        <strong>
          DeskCloak is a visual overlay utility for hiding desktop icons.
        </strong>{" "}
        The App does not delete, move, or modify any files on your desktop. Your
        desktop icons and files remain untouched underneath the overlay. Eduard
        Bruch assumes no liability for any issues arising from the use of the
        overlay feature, including but not limited to display conflicts with
        other applications.
      </p>
      ...
      <p className="mb-6">
        While the App is designed to work with standard macOS display
        configurations, we do not warrant compatibility with every display setup,
        wallpaper type, or macOS version. The App depends on macOS system APIs
        that may change with operating system updates.
      </p>
      ...
      <p className="mb-6">
        Overlay preferences and display settings you configure within the App are
      ...
      <p className="mb-6">
        ...
        display conflicts or visual artifacts; (c) any incompatibility with your
        system configuration; or (d) any unauthorized access to or loss of your
      ...
      <p className="mb-6">
        ...
        will be compatible with all display configurations or macOS versions. We
        do not warrant that the App will be uninterrupted, error-free, or free of
        harmful components.
      </p>
