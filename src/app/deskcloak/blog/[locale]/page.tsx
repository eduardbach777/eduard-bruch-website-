...
const APP_STORE_URL = "https://apps.apple.com/app/deskcloak/id6806639170";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "DeskCloak — Desktop Cover Blog",
    description: "Cover your messy desktop in one click — wallpaper, blur, or solid color.",
  };
}
...
export default async function DeskcloakBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#8E8E93] mb-5">
          DeskCloak — Desktop Cover
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#8E8E9366", background: "#8E8E9314" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">DeskCloak</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#8E8E93] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
