export const metadata = {
  title: "Privacy Policy — DeskCloak",
  description:
    "Privacy policy for DeskCloak - Desktop Privacy Screen by Eduard Bruch. No data collected, no tracking, no analytics.",
};

export default function DeskcloakPrivacy() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-2 text-lg text-neutral-300">
        DeskCloak &mdash; Desktop Privacy Screen
      </p>
      ...
      <p className="mb-6">
        This privacy policy describes how DeskCloak (&quot;the App&quot;),
      ...
      <p className="mb-4 border-l-4 border-emerald-500 pl-4 font-medium text-white">
        None. DeskCloak collects zero personal data.
      </p>
      <p className="mb-6">
        The App is a paid, one-time-purchase macOS utility that hides your
        desktop icons with a blur or wallpaper overlay for a clean, private
        screen. It does not require an account, does not use analytics or
        tracking frameworks, does not contain advertising, and does not transmit
        any data to external servers. All preferences are stored exclusively on
      ...
      <p className="mb-6">
        The App reads your current desktop wallpaper to create a seamless overlay
        that hides desktop icons. This information is processed entirely on your
        device. The wallpaper image is used only for display purposes and is
        never stored separately, copied, or transmitted to any server.
      </p>
      ...
      <ul className="mb-6 list-disc pl-6 space-y-2">
        <li>Overlay mode preference (blur or wallpaper)</li>
        <li>Blur intensity and display settings</li>
      ...
      <p className="mb-6">
        DeskCloak does not integrate any third-party services. There are no
      ...
      <p className="mb-6">
        DeskCloak accesses your desktop wallpaper to render the privacy overlay.
        The App does not request access to your camera, microphone, photos,
        contacts, location, or any other sensitive device feature beyond standard
        app execution and wallpaper reading.
      </p>
