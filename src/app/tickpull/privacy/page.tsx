export const metadata = {
  title: "Privacy Policy — Tickpull",
  description:
    "Privacy policy for Tickpull - Menu Bar Timer by Eduard Bruch. No data collected, no tracking, no analytics.",
};

export default function TickpullPrivacy() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-neutral-200">
      ...
      <p className="mb-6">
        This privacy policy describes how Tickpull (&quot;the App&quot;),
      ...
      <p className="mb-4 border-l-4 border-emerald-500 pl-4 font-medium text-white">
        None. Tickpull collects zero personal data.
      </p>
      <p className="mb-6">
        The App is a paid, one-time-purchase macOS utility that provides
        drag-to-set timers in your menu bar. It does not require an account, does
        not use analytics or tracking frameworks, does not contain advertising,
        and does not transmit any data to external servers. All timer data and
        preferences are stored exclusively on your device and are never sent
        anywhere.
      </p>
      ...
      <p className="mb-6">
        The App creates and manages timers based on your input. All timer
        durations, labels, and history are processed and stored entirely on your
        device. No timer data is transmitted to any server.
      </p>
      ...
      <ul className="mb-6 list-disc pl-6 space-y-2">
        <li>Timer history and saved timer durations</li>
        <li>Timer labels and notification preferences</li>
      ...
      <p className="mb-6">
        Tickpull does not integrate any third-party services. There are no
      ...
      <p className="mb-6">
        Tickpull may request permission to send notifications to alert you when a
        timer completes. This is the only permission the App requests. The App
