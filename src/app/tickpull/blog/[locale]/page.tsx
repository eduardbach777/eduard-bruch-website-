...
const APP_STORE_URL = "https://apps.apple.com/app/tickpull/id6806640763";

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tickpull — Menu Bar Timer Blog",
    description: "Set a timer by dragging — no clicks, no typing, just one gesture.",
  };
}
...
export default async function TickpullBlogPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      <section className="px-6 pt-36 pb-14 sm:pb-16 max-w-6xl mx-auto">
        <p className="font-mono text-xs sm:text-sm font-medium uppercase tracking-[0.22em] text-[#FF6B6B] mb-5">
          Tickpull — Menu Bar Timer
        </p>
        ...
        <a
          ...
          style={{ borderColor: "#FF6B6B66", background: "#FF6B6B14" }}
        >
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Tickpull</h2>
      ...
      <footer className="px-6 py-10 max-w-6xl mx-auto border-t border-neutral-800">
        <nav className="flex items-center justify-center gap-6 text-sm text-neutral-500" dir="ltr">
          ...
          <span className="text-[#FF6B6B] font-medium">Blog</span>
        </nav>
      </footer>
    </main>
  );
