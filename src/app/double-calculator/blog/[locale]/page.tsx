...
const APP_STORE_URL = buildStoreUrl({
  ...
  appId: "6760940001",
  campaign: campaignFor.blogIndex("double-calculator"),
});

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Double Calculator — Tax & VAT Blog",
    description: "Add or remove VAT and sales tax from any price, instantly.",
  };
}
...
export default async function DoubleCalculatorBlogPage({
  params,
}: {
    ...
    <main className="min-h-screen bg-[#050506] text-white" dir={isRtl ? "rtl" : undefined}>
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        <BlogListClient
          articles={articles}
          locale={locale}
          basePath="/double-calculator/blog"
          locales={LOCALES}
          readMore={readMore}
          isRtl={isRtl}
        />
      ...
      <section className="px-6 py-14 sm:py-16 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="relative">
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold text-white">Double Calculator</h2>
